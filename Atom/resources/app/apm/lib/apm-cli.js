(function() {
  var colors, commandClass, commandClasses, commands, config, fs, getPythonVersion, git, name, npm, optimist, parseOptions, path, printVersions, setupTempDirectory, spawn, wordwrap, _, _i, _j, _len, _len1, _ref, _ref1;
