...
3. プログラムは **半角英数字** で書きます。何かプログラムを書いたら、必ず保存しよう。
...
最初は、ゲームの基となるウィンドウを表示してみましょう。

### main.rb
『main.rb』をエディタで開いて、以下のプログラムを追加してください。

```{.ruby .numberLines startFrom="3"}
Window.height += 64
...
### bomber/player.rb
エディタで新規作成を選択して、新しいファイルを作れるようにします。
